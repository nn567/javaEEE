...
public class gestionFederation implements gestionFederationLocal {
    ...
    public void creerMatch(String eq1, String eq2, long id, String date) {
        ...
        List<Match> liste = matchFacade.recupMatchsArbitre(a);

        List<Match> listeME1 = matchFacade.recupMatchsEquipe(equipe1);
        
        List<Match> listeME2 = matchFacade.recupMatchsEquipe(equipe2);
       ...
       Date d = java.sql.Date.valueOf(date);
        ...
        if (equipe1 != null && equipe2 != null && a != null && d != null) {
            ...
            {
                for (Match m : listeME1) // on récupère les matchs de l'équipe 1
                {
            ...
            if (b1&&b2&&b3)
            {
                matchFacade.creerMatch(d, 0, 0, a);
            }
        }
    ...
    public List<FauteComise> afficherFautesArbitre(String n, String p) {
        ...
        List<Match> listeM = matchFacade.recupMatchsArbitre(a);
